...
# 模型选择：
# - qwen-plus: 性价比高，适合日常批量处理（推荐）
# - qwen-max: 最强推理，适合复杂政策分析（贵一些）
# - qwen-turbo: 最快最便宜，适合简单分类
...
def batch_analyze(entries):
    ...
    for i, entry in enumerate(entries, 1):
        ...
        # 阿里云百炼限速：qwen-plus约60 RPM，加延迟避免触发
        if i < total and i % 10 == 0:
            print("  [AI] Rate limit protection: sleeping 6s...")
            import time
            time.sleep(6)
